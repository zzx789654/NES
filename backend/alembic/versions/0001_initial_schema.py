...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("risk_factor", sa.String(50), nullable=True),
        sa.Column("stig_severity", sa.String(20), nullable=True),
        ...
        sa.Column("cvss_v2_base", sa.Numeric(4, 1), nullable=True),
        sa.Column("cvss_v2_temporal", sa.Numeric(4, 1), nullable=True),
        sa.Column("cvss_v3_base", sa.Numeric(4, 1), nullable=True),
        sa.Column("cvss_v3_temporal", sa.Numeric(4, 1), nullable=True),
        sa.Column("cvss_v4_base", sa.Numeric(4, 1), nullable=True),
        sa.Column("cvss_v4_threat_score", sa.Numeric(4, 1), nullable=True),
        ...
        sa.Column("bid", sa.String(50), nullable=True),
        sa.Column("xref", sa.Text, nullable=True),
        sa.Column("mskb", sa.String(50), nullable=True),
        sa.Column("plugin_publication_date", sa.Date, nullable=True),
        sa.Column("plugin_modification_date", sa.Date, nullable=True),
        sa.Column("metasploit", sa.Boolean, default=False),
        sa.Column("core_impact", sa.Boolean, default=False),
        sa.Column("canvas", sa.Boolean, default=False),
    )
    op.create_table(
        "audit_scans",
        sa.Column("id", sa.Integer, primary_key=True),
