  ...
  const SCAN_LIBRARY = {
    'scan-2024q3': {
      ...
      vulns: [
        ...
        { id:'v014', plugin_id:'153543', cve:'CVE-2022-42889', cvss:'9.8', risk:'Critical', host:'192.168.1.20', protocol:'tcp', port:'8080', name:'Apache Commons Text RCE (Text4Shell)', synopsis:'Apache Commons Text 遠端程式碼執行', description:'Apache Commons Text 1.5 至 1.9 版本存在 RCE 漏洞，類似 Log4Shell，透過字串插值觸發。', solution:'升級 Apache Commons Text 至 1.10.0 或以上版本。', plugin_output:'commons-text-1.9.jar detected in classpath' },
    ...
    'scan-2024q4': {
      ...
      vulns: [
        ...
        { id:'v014', plugin_id:'153543', cve:'CVE-2022-42889', cvss:'9.8', risk:'Critical', host:'192.168.1.20', protocol:'tcp', port:'8080', name:'Apache Commons Text RCE (Text4Shell)', synopsis:'Apache Commons Text RCE', description:'Apache Commons Text 1.5 至 1.9 版本存在 RCE 漏洞。', solution:'升級至 1.10.0。', plugin_output:'commons-text-1.9.jar detected' },
    ...
    'scan-2025q1': {
      ...
      vulns: [
        ...
        { id:'v014', plugin_id:'153543', cve:'CVE-2022-42889', cvss:'9.8', risk:'Critical', host:'192.168.1.20', protocol:'tcp', port:'8080', name:'Apache Commons Text RCE (Text4Shell)', synopsis:'Text4Shell RCE', description:'透過字串插值觸發 RCE。', solution:'升級至 1.10.0。', plugin_output:'commons-text-1.9.jar detected' },
